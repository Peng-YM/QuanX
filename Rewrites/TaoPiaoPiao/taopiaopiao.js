...
淘票票豆瓣评分=type=http-request, requires-body=0, pattern=^https:\/\/guide-acs\.m\.taobao\.com\/gw\/mtop\.film\.mtopshowapi\.getextendshowbyid, script-path=https://raw.githubusercontent.com/Peng-YM/QuanX/master/Rewrites/TaoPiaoPiao/taopiaopiao.js

[Loon]
hostname = guide-acs.m.taobao.com
http-request ^https:\/\/guide-acs\.m\.taobao\.com\/gw\/mtop\.film\.mtopshowapi\.getextendshowbyid requires-body=0, script-path=https://raw.githubusercontent.com/Peng-YM/QuanX/master/Rewrites/TaoPiaoPiao/taopiaopiao.js, tag=淘票票豆瓣评分
...
function queryDoubanInfo({ title, imdbId }) {
    ...
    return $.http.get({
        url: `https://www.douban.com/search?cat=1002&q=${encodeURIComponent(imdbId)}`,
        headers: {
